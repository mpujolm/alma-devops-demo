...
## Post-pull checklist
- After pulling changes from GitHub (git pull / merge), always deploy any FlexiPages included in the pull — they do not auto-activate in the org and must be explicitly deployed.
